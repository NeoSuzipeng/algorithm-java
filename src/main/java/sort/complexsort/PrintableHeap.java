 ...
 * 打印堆元素
 */
public class PrintableHeap extends HeapSort<Comparable<Integer>>{
    public PrintableHeap(int capacity){
        super(capacity);
    }

    public PrintableHeap(Comparable[] array){
        super(array);
    }
    ...
    public static void main(String[] args) {
        ...
        PrintableHeap maxHeap = new PrintableHeap(100);
        int N = 31; // 堆中元素个数
